...
export function PricingSection({
	...
	return (
		...
		>
			...
			{/* Hide frequency toggle if no plans have yearly pricing */}
			{plans.some(plan => plan.price.yearly) && (
		...
		>
			...
			>
				<div className="absolute top-2 right-2 z-10 flex items-center gap-2">
					...
					{frequency === 'yearly' && plan.price.yearly && (
				...
				<h3 className="mt-2 flex items-end gap-1">
					<span className="text-3xl font-bold">
						${frequency === 'yearly' && plan.price.yearly ? plan.price.yearly : plan.price.monthly}
					</span>
