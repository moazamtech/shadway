...
export const CodeBlockHeader = ({
  ...
  <div
    className={cn(
      'sticky top-0 z-10 flex flex-row items-center border-b bg-secondary/80 backdrop-blur-sm p-1',
      className
    )}
    {...props}
  />
...
export const CodeBlockFilename = ({
  ...
  return (
    ...
    >
      ...
      <span className="flex-1 truncate">\{getLanguageDisplayName(value || '')}</span>
    </div>
  );
};
